...
test("renders 3 buttons", () => {
  render(<TabList items={items} activeItemIndex={0} onIndexChange={null} />);
...
test("index 1 button is aria selected", () => {
  render(<TabList items={items} activeItemIndex={1} onIndexChange={null} />);
  const buttonElements = screen.getAllByRole("button");
...
test("index 0 button click callback", () => {
  ...
  render(
    <TabList items={items} activeItemIndex={0} onIndexChange={clickHandler} />
  );
  const buttonElements = screen.getAllByRole("button");
...
test("index 0 button key left no callback", () => {
  ...
  render(
    <TabList items={items} activeItemIndex={0} onIndexChange={keyDownHandler} />
  );
  const buttonElements = screen.getAllByRole("button");
  const button0 = buttonElements[0];
...
test("index 2 button key right no callback", () => {
  const keyDownHandler = jest.fn();
  render(
    <TabList items={items} activeItemIndex={2} onIndexChange={keyDownHandler} />
  );
  const buttonElements = screen.getAllByRole("button");
